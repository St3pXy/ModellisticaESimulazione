...
\begin{align*}
    E = T + U = \frac{1}{2}m\dot{x}^2 + \frac{1}{2}k\dot{x}^2
\end{align*}
...
Si identificano poi:
\begin{align*}
    \textit{Potenza Apparente: } \qquad &\sqrt{P^2 + Q^2} \\
...
\begin{enumerate}
    \item problemi sulla potenza attiva, che comprende: stagilità dell'angolo di carico, stabilità della frequenza. \\
    \item problemi sulla potenza reattiva, che comprende: stabilità del voltaggio.
\end{enumerate}
